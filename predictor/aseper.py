...
from asep.utils import config_parser, my_debug, print_args, print_flag, print_header, NameSpace, DEBUG
...
def cli_parser():
    ...
    _group.add_argument("--max-na-ratio", dest="max_na_ratio", default=0.5, type=float, help="The maximum ratio of NA in each feature, otherwise, the feature will be abundant")
    ...
    config_argparser.add_argument("-c", "--check", dest="config_file", type=str, default="configs.yaml", help="Check whether the config file in current directory is default. Default: configs.yaml")
